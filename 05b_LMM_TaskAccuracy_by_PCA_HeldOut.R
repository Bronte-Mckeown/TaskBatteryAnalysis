"
x1 mixed LM to predict task accuracy by held-out PCAs.
...
# average data by person and task
df1 <- merged %>%
...
myfile2 <- file.path(results_dir,"LMM_acc_pca_holdout_summary")
