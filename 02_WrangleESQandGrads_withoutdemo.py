...
# esq_df = lab_data.drop(["Runtime_mod", "Note"], axis=1)
...
# replace_dict_country = {"Canad": "Canada", "Cnada": "Canada", "Canada ": "Canada"}
...
# print(
#     "Number of PS after removing those with no demographics:",
#     len(esq_df["Id_number"].unique()),
# )
...
###################################################################################
esq_df = pd.read_csv("scratch//data//esq_demo_forPCA.csv",index_col="Task_name")
## read in grad data and make changes to index
grad_data = pd.read_csv(
    "scratch//data//gradscores_spearman_combinedmask_cortical_subcortical.csv"
)
