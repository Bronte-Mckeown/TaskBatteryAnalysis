...
model_og.save(
    path="scratch//results//pca//allTasks", pathprefix=f"allTasksNoRotation{n_comp}"
)
...
model_project.save(
    path="scratch//results//pca//replication",
    pathprefix=f"projected_replicationNoRotation{n_comp}",
)
...
model_rep.save(
    path="scratch//results//pca//replication",
    pathprefix=f"replicationNoRotation{n_comp}",
)
