This repository contains all code and data to reproduce the results reported in Mckeown et al. (2024) "Self-reports map the landscape of task states derived from brain imaging"
