...
############################ Data read ##############################################
# read in data
pca_loadings = pd.read_csv('scratch\\results\\pca\\allTasks\\allTasksNoRotation5_24112023_10-19-32\\csvdata\\pca_loadings.csv')
cca_weights = pd.read_csv('scratch\\results\\cca\\allTasks\\pca_weights_noRot_5ncomp.csv')
...
plotting.save_wordclouds(coefficients_df, 'scratch\\results\\cca\\allTasks\\projectedWordClouds')
